...
### 입력 
 ...
 <p>첫 번째 줄에 standardOfJava.Test case의 수 T가 주어진다. 그리고 각각의 케이스마다 입력으로 첫 번째 줄에 정수 k, 두 번째 줄에 정수 n이 주어진다</p>

### 출력 

 <p>각각의 standardOfJava.Test case에 대해서 해당 집에 거주민 수를 출력하라.</p>
