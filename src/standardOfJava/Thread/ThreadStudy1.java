...
//        standardOfJava.Thread t2 = new standardOfJava.Thread(new MyThread1()); 위 두 줄과 같은 코드임.
...
// Runnable을 구현하는 방법이 더 보편적이다(재사용성, 코드의 사용성, 상속에서 standardOfJava.Thread 상속보다 유리)
// standardOfJava.Thread 직접 상속 시 조상인 Thread의 값을 직접 호출 가능하다.
// Runnable 구현 시에는 standardOfJava.Thread 클래스의 static 메서드인 current standardOfJava.Thread()를 호출하여 쓰레드에 대한 참조를 얻어 와야만 호출 가능
