...
//        String[] strArr2 = {"aa","aa","BB","ff","gg","cc","ASD"};
//        Stream<String> stringStream4 = Arrays.stream(strArr2);
////        Stream<String> fillteredStream = stringStream4.filter();
//        Stream<String> distinctedStream = stringStream4.distinct();
//        Stream<String> sortedStream = stringStream4.sorted();
...
//        evenStream.forEach(System.out::println);
        ...
        // File
//        Stream<String> fileStream = Files.lines("PATH.txt");
